...
namespace SOUI{
	...
	SResProviderZip::SResProviderZip()
	{
	}
	...
	HBITMAP SResProviderZip::LoadBitmap( LPCTSTR strType,LPCTSTR pszResName )
	{
	...
	HICON SResProviderZip::LoadIcon( LPCTSTR strType,LPCTSTR pszResName ,int cx/*=0*/,int cy/*=0*/)
	{
		CDuiStringT strPath=GetFilePath(pszResName,strType);
		if(strPath.IsEmpty()) return NULL;
		CZipFile zf;
	...
	IDuiImage * SResProviderZip::LoadImage( LPCTSTR strType,LPCTSTR pszResName)
	{
		CDuiStringT strPath=GetFilePath(pszResName,strType);
		if(strPath.IsEmpty()) return NULL;
		CZipFile zf;
	...
	CDuiStringT SResProviderZip::GetFilePath( LPCTSTR pszResName,LPCTSTR pszType )
	{
