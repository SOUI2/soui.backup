...
namespace SOUI
{
	...
	public://richedit interface
		 ...
		 * Describe   设置窗口标题
		 */
		virtual void SetWindowText(LPCWSTR lpszText);
		/**
		 * SRichEdit::SetSel
		 * @brief     设置选中
	...
	protected:
		SStringW	m_strDefText;	/**< Edit 控件的一个默认文本内容*/
		COLORREF	m_dwDefColor;	/**< Edit 控件的默认文本字体颜色*/
		bool		m_bIsInit;
		bool		m_bIsPasswordEdit;
	};
}//namespace SOUI
