...
#define WIDTH_MENU_MIN      100.f
    ...
    public:
        ...
        virtual void UpdateChildrenPosition()
        {
            ...
            rcClient.DeflateRect(GetMargin());
    ...
    void SMenuExItem::OnPaint(IRenderTarget *pRT)
    {
        ...
        rc.top +=pMenuRoot->m_iconY.toPixelSize(GetScale());
    ...
    void SMenuEx::ShowMenu(UINT uFlag,int x,int y)
    {
        ...
        SetWindowPos(HWND_TOPMOST,rcMenu.left,rcMenu.top,szMenu.cx,szMenu.cy,SWP_SHOWWINDOW|SWP_NOACTIVATE|SWP_NOOWNERZORDER|SWP_NOSENDCHANGING);        
