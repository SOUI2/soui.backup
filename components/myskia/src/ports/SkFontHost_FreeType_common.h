...
//
//    static SkTypeface_FreeType* Create(const SkTypefaceID_FT& lf) {
//        
//        strcmp(tfInfo.familyName, lf.familyName);
//        tfInfo.style = lf.style;
//        SkFontID fontID = SkTypefaceCache::NewFontID();
//        return new SkTypeface_FreeType(tfInfo.style, fontID, false);
//    }
};
